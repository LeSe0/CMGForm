...
export const userSchema = () => {
  return Yup.object().shape({
    username: Yup.string()
      .matches(
        /^[a-z,A-Z,0-9"_“]+$/g,
        "Username can include only latin letters, and numbers"
      )
    ...
    firstname: Yup.string()
      .matches(
        /^[a-z,A-Z,0-9" "]+$/g,
        "First name can include only latin letters, and numbers"
      )
    ...
    lastname: Yup.string()
      .matches(
        /^[a-z,A-Z,0-9" "]+$/g,
        "Last name can include only latin letters, and numbers"
      )
